...
vowels = "аоеыиуюяэ"
poem = input().split()
countSyllables = list(map(lambda phrase: len(list(filter(lambda letter: letter in vowels, phrase))), poem))
if len(list(filter(lambda x: x != countSyllables[0], countSyllables))) == 0:
    print("Парам пам-пам")
else:
    print("Пам парам")
